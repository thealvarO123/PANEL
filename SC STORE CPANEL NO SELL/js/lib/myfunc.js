...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === veya.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = veya.user.id.split(':')[0]+'@s.whatsapp.net'
}
